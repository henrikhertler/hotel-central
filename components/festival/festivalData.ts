		...
		workshops: [
			{
				...
				person: {
					name: 'mit Stuttgarter Musiker <a target="_blank" href="https://www.instagram.com/elithesleepgod/">Elias</a>',
				},
				price: '20 Euro',
				registerHref:
		...
		workshops: [
			{
				...
				person: {
					name: 'mit Produzent <a target="_blank" href="https://www.instagram.com/luzifersfinest/">Roman</a>',
				},
				price: '20 Euro',
				registerHref:
		...
		workshops: [
			{
				...
				person: {
					name: 'mit Stuttgarter <a target="_blank" href="https://www.instagram.com/duperyota/">DJ Yota</a>',
				},
				price: '20 Euro',
				registerHref:
		...
		workshops: [
			{
				...
				description: 'Wer schon einmal einen Film auf einer Analog-Kamera vollgeknipst hat, weiß, wie teuer die Entwicklungskosten dafür sein können. Dazu ist die Entwicklung häufig auch an lange Wartezeiten gebunden. Das mag zwar durchaus seinen Reiz haben, kann aber auch umgangen werden. Ganz einfach: indem man selbst Hand anlegt. ' +
					'<a target="_blank" href="https://www.instagram.com/thatswhatshesaeed/Saeed Kakavand">Saeed Kakavand</a> ' +
					'hat in seiner Arbeit als Fotograf schon vielfach analog fotografiert. Die vollen Filme hat er im Anschluss daran häufig eigenhändig entwickelt. Wie das funktioniert und worauf es dabei zu achten gilt, zeigt Saeed in seinem Workshop am 07. November!',
				person: {
					name: 'mit Fotograf <a target="_blank" href="https://www.instagram.com/thatswhatshesaeed/">Saeed</a>',
				},
				price: '20 Euro',
				registerHref:
